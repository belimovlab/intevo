...
<div class="block">
   <table width="100%" bgcolor="#f6f4f5" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
      <tbody>
         <tr>
            <td>
               <table width="580" bgcolor="#00BCD4" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hlitebg="edit" shadow="edit">
                  <tbody>
                     <tr>
                        <td>
                           <!-- logo -->
                              ...
                              <tbody>
                                 <tr>
                                    <td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
                                       <div class="imgpop">
                                           <a href="<?php base_url('/')?>" style="color: #fff; text-decoration: none; font-size: 24px;">Intevo.cms</a>
                                       </div>
                                    </td>
                                 </tr>
                              </tbody>
                              ...
                              <tbody>
                                ...
                                <tr>
                                   <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #95a5a6; text-align:center;line-height: 30px;" st-content="fulltext-paragraph">
                                      Для того, чтобы восстановить пароль нажмите на кнопку
                                   </td>
                                </tr>
                                <tr>
                                              ...
                                              <tr>
                                               <td width="auto" align="center" valign="middle" height="36" style=" background-color:#0db9ea; border-top-left-radius:4px; border-bottom-left-radius:4px;border-top-right-radius:4px; border-bottom-right-radius:4px; background-clip: padding-box;font-size:13px; font-family:Helvetica, arial, sans-serif; text-align:center;  color:#ffffff; font-weight: 300; padding-left:25px; padding-right:25px;">
                                                   <span style="color: #ffffff; font-weight: 300;">
                                                      <a style="color: #ffffff; text-align:center;text-decoration: none;" href="<?php echo base_url('/profile/reset_password/'.$email.'/'.$active_code)?>">Восстановить пароль</a>
                                                   </span>
                                               </td>
                                              </tr>
                                           </tbody>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #95a5a6; text-align:center;line-height: 30px; word-wrap: break-word; width: 580px;" st-content="fulltext-paragraph" width="580">
                                        <a  href="<?php echo base_url('/profile/reset_password/'.$email.'/'.$active_code)?>" style=" color: #0db9ea; word-wrap: break-word;" width="580">Ссылка для восстановления пароля</a>
                                        <a href="#"></a> 
                                    </td>
                                </tr>
                                <tr>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999" st-content="preheader">
                           Это письмо создано автоматически. На него не надо отвечать. 
                        </td>
                     </tr>
                     <tr>
                        <td width="100%" height="5"></td>
